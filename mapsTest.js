                ...
                $.getJSON("http://bells.veniceprojectcenter.org/bells.json", function(result) {
                   ...
                   $.each(result, function(key, val) {
                        ...
                        google.maps.event.addListener(marker, 'click', function () {
                            var markerContent = '<div id="accordion"><h3>' + val.fullname + '<h3><div><p>Information</p></div></div><div><button type="button">Play</button><button type="button">Venipedia</button></div>';
